...
I got the first glance into the React "lifecycle", which is especially useful for someone who used to build frontends with Web Components (Polymer, LitElement, lit-html). The `hook-flow` example was particularly illustrative. I have now a deep understanding on how `useEffect` works, and I even got a good example on when and how to use `useRef` in extra credit 4.
## Background
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=02%3A%20useEffect%3A%20persistent%20state&em=jaime.ferbec%40gmail.com).

...
I learnt how to put all my React knowledge up to this point to use. It was important to get the first warning about mutating state and the side effects it might have in React (I'm guessing the course will get deeper into this topic further on). I also got into my mind this new way of sesing state: separating state as managed and derived. It was nice to get a more practical example of lifted state, as well.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=04%3A%20useState%3A%20tic%20tac%20toe&em=jaime.ferbec%40gmail.com).
